...
const latestRfidFirmware="1.7.1";
    ...
    <section className="panel rfid-setup-panel">
      ...
      {setupMode==="esp32"&&<div className="rfid-setup-content" role="tabpanel">
        <div className="rfid-ble-setup">
          <div className="rfid-ble-heading"><span><IconBluetooth size={24}/></span><div><strong>ESP32-Leser direkt verbinden</strong><small>Neue und bereits eingerichtete Leser werden vollständig in ClubIQ verbunden.</small></div><em className={bleSupport}>{bleSupport==="ready"?"Bluetooth bereit":bleSupport==="checking"?"Wird geprüft":"Browser ungeeignet"}</em></div>
