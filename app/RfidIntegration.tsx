...
const latestRfidFirmware="1.6.0";
...
export function RfidDevicePanel(){
  ...
  return <section className="panel rfid-device-panel"><div className="panel-head"><div><p className="eyebrow">EXTERNER KARTENLESER</p><h2>ESP8266 + MFRC522</h2></div><span><IconWifi size={20}/> Ohne PC koppeln</span></div>
    ...
    <div className="rfid-pairing-guide"><strong>Leser in drei Schritten verbinden</strong><ol><li>ClubIQ-Zertifikat einmal unter <code>http://vereinskasse.local:8080/vereinskasse-ca.crt</code> herunterladen.</li><li>Mit <b>NFC-Reader-…</b> verbinden, <code>http://192.168.4.1</code> öffnen und dort WLAN, Kennwort und Zertifikatsdatei auswählen.</li><li><b>Leser verbinden</b> drücken und den angezeigten Code hier bestätigen.</li></ol><small>Zieladresse: <code>{endpoint}</code>. Token und Zertifikatstext werden automatisch eingerichtet.</small></div>
