...
export async function GET(request:Request){
  ...
  const reversal=sale.reversalId?`<section class="reversal"><strong>STORNIERT</strong><span>${esc(sale.reversalReason||"Korrektur")} · ${new Date(String(sale.reversedAt)).toLocaleString("de-DE")}</span></section>`:"";
