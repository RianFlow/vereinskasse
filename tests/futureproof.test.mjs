...
test("verwendet das Clubiq-Logo und den Slogan ohne das Kassentheme umzubauen",async()=>{
  ...
  for(const feature of ["APP_VERSION","APP_DEVELOPER","APP_COPYRIGHT_YEAR","1.3.1","Florian Hümmling"])assert.ok(info.includes(feature),`${feature} fehlt`);
  ...
  assert.ok(packageFile.includes('"version": "1.3.1"'),"Paketversion stimmt nicht mit der sichtbaren Version überein");
